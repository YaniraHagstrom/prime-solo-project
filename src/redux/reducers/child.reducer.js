...
const childReducer = (state = {}, action)=> {
    switch (action.type){
        ...
        // adds the child_id after child is added to DB for use in initial provider search.
        case 'UPDATE_CHILD_DATA':
            return {...state, child_id: action.payload}
            case 'SET_NAME':
            ...
            case 'SET_LANGUAGE2':
                return {...state, secondarylanguage_id: action.payload};
            case 'SET_CHECKED1':
            ...
            case 'SET_CHECKED7':
                return {...state, 1:action.payload}
            case 'SET_CHECKED1':
                return {...state, 7:action.payload}
            case 'SET_CHECKED8':
                return {...state, 8:action.payload}
            case 'SET_CHECKED9':
                return {...state, 9:action.payload}
            case 'SET_CHECKED10':
